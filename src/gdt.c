...
void init_gdt() {
    ...
    // DATA USER SEGMENT
    set_GDT_Gate(&g_GDT[4], 0x0, 0xFFFFF, PRESENT | DPL_USER | S_CODE_DATA_SEGMENT | E_DATA | DC_DATA_UP | RW_SEG_CODE_READ_ACTIVATED | ACCESSED, GRANULARITY | DESCRIPTOR_SIZE_32);
